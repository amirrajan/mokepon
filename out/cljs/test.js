...
var args35327 = [];
var len__29087__auto___35331 = arguments.length;
var i__29088__auto___35332 = (0);
while(true){
if((i__29088__auto___35332 < len__29087__auto___35331)){
args35327.push((arguments[i__29088__auto___35332]));

var G__35333 = (i__29088__auto___35332 + (1));
i__29088__auto___35332 = G__35333;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args35327.length)].join('')));
...
var G__35330 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__35330,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__35330;
}
});
...
var len__29087__auto___35338 = arguments.length;
var i__29088__auto___35339 = (0);
while(true){
if((i__29088__auto___35339 < len__29087__auto___35338)){
args__29094__auto__.push((arguments[i__29088__auto___35339]));

var G__35340 = (i__29088__auto___35339 + (1));
i__29088__auto___35339 = G__35340;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq35335){
var G__35336 = cljs.core.first.call(null,seq35335);
var seq35335__$1 = cljs.core.next.call(null,seq35335);
var G__35337 = cljs.core.first.call(null,seq35335__$1);
var seq35335__$2 = cljs.core.next.call(null,seq35335__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__35336,G__35337,seq35335__$2);
});
...
var file = cljs.core.get.call(null,map__35344__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__35344__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__35344__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__35344,map__35344__$1,file,line,column){
return (function (p1__35341_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__35341_SHARP_));
});})(map__35344,map__35344__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__28937__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__28937__auto__,prefer_table__28938__auto__,method_cache__28939__auto__,cached_hierarchy__28940__auto__,hierarchy__28941__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__28012__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__28012__auto__)){
return or__28012__auto__;
} else {
...
var temp__4657__auto___35346 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___35346)){
var message_35347 = temp__4657__auto___35346;
cljs.core.println.call(null,message_35347);
} else {
}
...
var temp__4657__auto___35348 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___35348)){
var message_35349 = temp__4657__auto___35348;
cljs.core.println.call(null,message_35349);
} else {
}
...
var G__35359 = exception.stack;
var G__35359__$1 = (((G__35359 == null))?null:clojure.string.split_lines.call(null,G__35359));
var G__35359__$2 = (((G__35359__$1 == null))?null:cljs.core.get.call(null,G__35359__$1,depth));
if((G__35359__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__35359__$2);
}
} else {
...
var vec__35360 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__35360,(0),null);
var column = cljs.core.nth.call(null,vec__35360,(1),null);
var vec__35363 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__35363,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__35363,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__35363,(2),null);
...
var m__$1 = (function (){var G__35367 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__35367) {
case "fail":
...
var G__35373 = (function (){var G__35372 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__35372);
} else {
return G__35372;
}
})();
...
return cljs.core.vary_meta.call(null,G__35375,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__35379 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__35379) {
...
var vec__35384 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__35384,(0),null);
var types = vec__35384;
...
return cljs.core.map.call(null,(function (p__35396){
var vec__35397 = p__35396;
var ns = cljs.core.nth.call(null,vec__35397,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__35397,(1),null);
return ((function (vec__35397,ns,vars__$1){
return (function (){
...
var G__35400 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__35400) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__35400,env,once_fixtures,each_fixtures,vec__35397,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__35400,env,once_fixtures,each_fixtures,vec__35397,ns,vars__$1){
return (function (){
var seq__35401 = cljs.core.seq.call(null,vars__$1);
var chunk__35402 = null;
var count__35403 = (0);
var i__35404 = (0);
while(true){
if((i__35404 < count__35403)){
var v = cljs.core._nth.call(null,chunk__35402,i__35404);
var temp__4657__auto___35406 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___35406)){
var t_35407 = temp__4657__auto___35406;
each_fixture_fn.call(null,((function (seq__35401,chunk__35402,count__35403,i__35404,t_35407,temp__4657__auto___35406,v,each_fixture_fn,G__35400,env,once_fixtures,each_fixtures,vec__35397,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35407)));
});})(seq__35401,chunk__35402,count__35403,i__35404,t_35407,temp__4657__auto___35406,v,each_fixture_fn,G__35400,env,once_fixtures,each_fixtures,vec__35397,ns,vars__$1))
);
} else {
}

var G__35408 = seq__35401;
var G__35409 = chunk__35402;
var G__35410 = count__35403;
var G__35411 = (i__35404 + (1));
seq__35401 = G__35408;
chunk__35402 = G__35409;
count__35403 = G__35410;
i__35404 = G__35411;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__35401);
if(temp__4657__auto__){
var seq__35401__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__35401__$1)){
var c__28823__auto__ = cljs.core.chunk_first.call(null,seq__35401__$1);
var G__35412 = cljs.core.chunk_rest.call(null,seq__35401__$1);
var G__35413 = c__28823__auto__;
var G__35414 = cljs.core.count.call(null,c__28823__auto__);
var G__35415 = (0);
seq__35401 = G__35412;
chunk__35402 = G__35413;
count__35403 = G__35414;
i__35404 = G__35415;
continue;
} else {
var v = cljs.core.first.call(null,seq__35401__$1);
var temp__4657__auto___35416__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___35416__$1)){
var t_35417 = temp__4657__auto___35416__$1;
each_fixture_fn.call(null,((function (seq__35401,chunk__35402,count__35403,i__35404,t_35417,temp__4657__auto___35416__$1,v,seq__35401__$1,temp__4657__auto__,each_fixture_fn,G__35400,env,once_fixtures,each_fixtures,vec__35397,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35417)));
});})(seq__35401,chunk__35402,count__35403,i__35404,t_35417,temp__4657__auto___35416__$1,v,seq__35401__$1,temp__4657__auto__,each_fixture_fn,G__35400,env,once_fixtures,each_fixtures,vec__35397,ns,vars__$1))
);
} else {
}

var G__35418 = cljs.core.next.call(null,seq__35401__$1);
var G__35419 = null;
var G__35420 = (0);
var G__35421 = (0);
seq__35401 = G__35418;
chunk__35402 = G__35419;
count__35403 = G__35420;
i__35404 = G__35421;
continue;
}
} else {
...
});})(each_fixture_fn,G__35400,env,once_fixtures,each_fixtures,vec__35397,ns,vars__$1))
);
});})(each_fixture_fn,G__35400,env,once_fixtures,each_fixtures,vec__35397,ns,vars__$1))
], null);
