...
alandipert.storage_atom.transit_read_handlers = (function (){var G__38134 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__38134) : cljs.core.atom.call(null,G__38134));
})();
alandipert.storage_atom.transit_write_handlers = (function (){var G__38135 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__38135) : cljs.core.atom.call(null,G__38135));
})();
...
var G__38139_38142 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(f) : cljs.core.deref.call(null,f));
goog.Timer.clear(G__38139_38142);
} else {
}

var G__38140 = f;
var G__38141 = goog.Timer.callOnce(func,ttime);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__38140,G__38141) : cljs.core.reset_BANG_.call(null,G__38140,G__38141));
});
;})(f))
});
/**
...
var G__38150 = atom;
cljs.core.add_watch(G__38150,cljs.core.cst$kw$alandipert$storage_DASH_atom_SLASH_storage_DASH_watch,((function (G__38150,existing,debounce){
return (function (p1__38145_SHARP_,p2__38146_SHARP_,p3__38143_SHARP_,p4__38144_SHARP_){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p3__38143_SHARP_,p4__38144_SHARP_);
} else {
return and__18452__auto__;
}
})())){
var G__38151 = ((function (G__38150,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_(backend,p4__38144_SHARP_);
});})(G__38150,existing,debounce))
;
var G__38152 = (function (){var or__18464__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
return (debounce.cljs$core$IFn$_invoke$arity$2 ? debounce.cljs$core$IFn$_invoke$arity$2(G__38151,G__38152) : debounce.call(null,G__38151,G__38152));
} else {
return null;
}
});})(G__38150,existing,debounce))
...
var _STAR_watch_active_STAR_38158 = alandipert.storage_atom._STAR_watch_active_STAR_;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_38158;
}} else {
...
var _STAR_watch_active_STAR_38160 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{var G__38161 = atom;
var G__38162 = (function (){var value = e.newValue;
...
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__38161,G__38162) : cljs.core.reset_BANG_.call(null,G__38161,G__38162));
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_38160;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend(atom,storage,k,default$,p1__38163_SHARP_);
});})(default$))
);
});
/**
