...
alandipert.storage_atom.transit_read_handlers = (function (){var G__31095 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__31095) : cljs.core.atom.call(null,G__31095));
})();
alandipert.storage_atom.transit_write_handlers = (function (){var G__31096 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__31096) : cljs.core.atom.call(null,G__31096));
})();
...
var G__31100_31103 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(f) : cljs.core.deref.call(null,f));
goog.Timer.clear(G__31100_31103);
} else {
}

var G__31101 = f;
var G__31102 = goog.Timer.callOnce(func,ttime);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__31101,G__31102) : cljs.core.reset_BANG_.call(null,G__31101,G__31102));
});
;})(f))
});
/**
...
var G__31111 = atom;
cljs.core.add_watch(G__31111,cljs.core.cst$kw$alandipert$storage_DASH_atom_SLASH_storage_DASH_watch,((function (G__31111,existing,debounce){
return (function (p1__31106_SHARP_,p2__31107_SHARP_,p3__31104_SHARP_,p4__31105_SHARP_){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p3__31104_SHARP_,p4__31105_SHARP_);
} else {
return and__18452__auto__;
}
})())){
var G__31112 = ((function (G__31111,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_(backend,p4__31105_SHARP_);
});})(G__31111,existing,debounce))
;
var G__31113 = (function (){var or__18464__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
return (debounce.cljs$core$IFn$_invoke$arity$2 ? debounce.cljs$core$IFn$_invoke$arity$2(G__31112,G__31113) : debounce.call(null,G__31112,G__31113));
} else {
return null;
}
});})(G__31111,existing,debounce))
...
var _STAR_watch_active_STAR_31119 = alandipert.storage_atom._STAR_watch_active_STAR_;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_31119;
}} else {
...
var _STAR_watch_active_STAR_31121 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{var G__31122 = atom;
var G__31123 = (function (){var value = e.newValue;
...
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__31122,G__31123) : cljs.core.reset_BANG_.call(null,G__31122,G__31123));
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_31121;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend(atom,storage,k,default$,p1__31124_SHARP_);
});})(default$))
);
});
/**
