...
var G__29304 = atom;
cljs.core.add_watch.call(null,G__29304,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__29304,existing,debounce){
return (function (p1__29301_SHARP_,p2__29302_SHARP_,p3__29299_SHARP_,p4__29300_SHARP_){
...
return cljs.core.not_EQ_.call(null,p3__29299_SHARP_,p4__29300_SHARP_);
} else {
return and__28000__auto__;
}
})())){
return debounce.call(null,((function (G__29304,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__29300_SHARP_);
});})(G__29304,existing,debounce))
...
var _STAR_watch_active_STAR_29308 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_29308;
}} else {
...
var _STAR_watch_active_STAR_29310 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_29310;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__29311_SHARP_);
});})(default$))
);
});
/**
