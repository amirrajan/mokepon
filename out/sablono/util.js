...
sablono.util.as_str.cljs$lang$applyTo = (function (seq23773){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23773));
});
...
var vec__23780 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__23782;
var words = seq__23781__$1;
...
var G__23784 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__23784,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__23784;
}
} else {
...
var args__19546__auto__ = [];
var len__19539__auto___23787 = arguments.length;
var i__19540__auto___23788 = (0);
while(true){
if((i__19540__auto___23788 < len__19539__auto___23787)){
args__19546__auto__.push((arguments[i__19540__auto___23788]));

var G__23789 = (i__19540__auto___23788 + (1));
i__19540__auto___23788 = G__23789;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__23785_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__23785_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__23785_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__23785_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq23786){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23786));
});
...
var vec__23795 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__23795,(0),null);
var names = cljs.core.nth.call(null,vec__23795,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__23795,tag_name,names){
return (function (p1__23790_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__23790_SHARP_));
});})(matches,vec__23795,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__23795,tag_name,names){
return (function (p1__23791_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__23791_SHARP_));
});})(matches,vec__23795,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__23798){
var vec__23805 = p__23798;
...
var tag = first__23807;
var content = seq__23806__$1;
...
var vec__23808 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__23808,(0),null);
var id = cljs.core.nth.call(null,vec__23808,(1),null);
var class$ = cljs.core.nth.call(null,vec__23808,(2),null);
