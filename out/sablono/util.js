...
return m__28676__auto__.call(null,x);
} else {
var m__28676__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__28676__auto____$1 == null))){
return m__28676__auto____$1.call(null,x);
} else {
...
var len__29087__auto___36864 = arguments.length;
var i__29088__auto___36865 = (0);
while(true){
if((i__29088__auto___36865 < len__29087__auto___36864)){
args__29094__auto__.push((arguments[i__29088__auto___36865]));

var G__36866 = (i__29088__auto___36865 + (1));
i__29088__auto___36865 = G__36866;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq36863){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36863));
});
...
var vec__36870 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__36872;
var words = seq__36871__$1;
...
var G__36874 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__36874,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__36874;
}
} else {
...
var args__29094__auto__ = [];
var len__29087__auto___36877 = arguments.length;
var i__29088__auto___36878 = (0);
while(true){
if((i__29088__auto___36878 < len__29087__auto___36877)){
args__29094__auto__.push((arguments[i__29088__auto___36878]));

var G__36879 = (i__29088__auto___36878 + (1));
i__29088__auto___36878 = G__36879;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__36875_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__36875_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__36875_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__36875_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq36876){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36876));
});
...
var vec__36885 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__36885,(0),null);
var names = cljs.core.nth.call(null,vec__36885,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__36885,tag_name,names){
return (function (p1__36880_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__36880_SHARP_));
});})(matches,vec__36885,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__36885,tag_name,names){
return (function (p1__36881_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__36881_SHARP_));
});})(matches,vec__36885,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__36888){
var vec__36895 = p__36888;
...
var tag = first__36897;
var content = seq__36896__$1;
...
var vec__36898 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__36898,(0),null);
var id = cljs.core.nth.call(null,vec__36898,(1),null);
var class$ = cljs.core.nth.call(null,vec__36898,(2),null);
