...
var len__19539__auto___19716 = arguments.length;
var i__19540__auto___19717 = (0);
while(true){
if((i__19540__auto___19717 < len__19539__auto___19716)){
args__19546__auto__.push((arguments[i__19540__auto___19717]));

var G__19718 = (i__19540__auto___19717 + (1));
i__19540__auto___19717 = G__19718;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq19715){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19715));
});
...
var vec__19722 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__19724;
var words = seq__19723__$1;
...
var G__19726 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__19726,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__19726;
}
} else {
...
var args__19546__auto__ = [];
var len__19539__auto___19729 = arguments.length;
var i__19540__auto___19730 = (0);
while(true){
if((i__19540__auto___19730 < len__19539__auto___19729)){
args__19546__auto__.push((arguments[i__19540__auto___19730]));

var G__19731 = (i__19540__auto___19730 + (1));
i__19540__auto___19730 = G__19731;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__19727_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__19727_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__19727_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__19727_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq19728){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19728));
});
...
var vec__19737 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__19737,(0),null);
var names = cljs.core.nth.call(null,vec__19737,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__19737,tag_name,names){
return (function (p1__19732_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__19732_SHARP_));
});})(matches,vec__19737,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__19737,tag_name,names){
return (function (p1__19733_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__19733_SHARP_));
});})(matches,vec__19737,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__19740){
var vec__19747 = p__19740;
var seq__19748 = cljs.core.seq.call(null,vec__19747);
var first__19749 = cljs.core.first.call(null,seq__19748);
var seq__19748__$1 = cljs.core.next.call(null,seq__19748);
var tag = first__19749;
var content = seq__19748__$1;
...
var vec__19750 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__19750,(0),null);
var id = cljs.core.nth.call(null,vec__19750,(1),null);
var class$ = cljs.core.nth.call(null,vec__19750,(2),null);
