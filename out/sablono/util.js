...
var len__29087__auto___34964 = arguments.length;
var i__29088__auto___34965 = (0);
while(true){
if((i__29088__auto___34965 < len__29087__auto___34964)){
args__29094__auto__.push((arguments[i__29088__auto___34965]));

var G__34966 = (i__29088__auto___34965 + (1));
i__29088__auto___34965 = G__34966;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq34963){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34963));
});
...
var vec__34970 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__34971 = cljs.core.seq.call(null,vec__34970);
var first__34972 = cljs.core.first.call(null,seq__34971);
var seq__34971__$1 = cljs.core.next.call(null,seq__34971);
var first_word = first__34972;
var words = seq__34971__$1;
...
var G__34974 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__34974,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__34974;
}
} else {
...
var args__29094__auto__ = [];
var len__29087__auto___34977 = arguments.length;
var i__29088__auto___34978 = (0);
while(true){
if((i__29088__auto___34978 < len__29087__auto___34977)){
args__29094__auto__.push((arguments[i__29088__auto___34978]));

var G__34979 = (i__29088__auto___34978 + (1));
i__29088__auto___34978 = G__34979;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__34975_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__34975_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__34975_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__34975_SHARP_)){
return p1__34975_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__34975_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq34976){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34976));
});
...
var vec__34985 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__34985,(0),null);
var names = cljs.core.nth.call(null,vec__34985,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__34985,tag_name,names){
return (function (p1__34980_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__34980_SHARP_));
});})(matches,vec__34985,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__34985,tag_name,names){
return (function (p1__34981_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__34981_SHARP_));
});})(matches,vec__34985,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__34988){
var vec__34995 = p__34988;
...
var vec__34998 = sablono.util.match_tag.call(null,tag);
