...
var len__19539__auto___35223 = arguments.length;
var i__19540__auto___35224 = (0);
while(true){
if((i__19540__auto___35224 < len__19539__auto___35223)){
args__19546__auto__.push((arguments[i__19540__auto___35224]));

var G__35225 = (i__19540__auto___35224 + (1));
i__19540__auto___35224 = G__35225;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq35222){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq35222));
});
...
var vec__35229 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
...
var first_word = first__35231;
var words = seq__35230__$1;
...
var G__35233 = clojure.set.rename_keys(m,kmap);
if(cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__35233,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono$util$camel_case_keys);
} else {
return G__35233;
}
} else {
...
var args__19546__auto__ = [];
var len__19539__auto___35236 = arguments.length;
var i__19540__auto___35237 = (0);
while(true){
if((i__19540__auto___35237 < len__19539__auto___35236)){
args__19546__auto__.push((arguments[i__19540__auto___35237]));

var G__35238 = (i__19540__auto___35237 + (1));
i__19540__auto___35237 = G__35238;
continue;
} else {
}
break;
...
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__35234_SHARP_){
if(cljs.core.list_QMARK_(p1__35234_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__35234_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__35234_SHARP_)){
return p1__35234_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__35234_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq35235){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq35235));
});
...
var vec__35244 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35244,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35244,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__35244,tag_name,names){
return (function (p1__35239_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__35239_SHARP_));
});})(matches,vec__35244,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__35244,tag_name,names){
return (function (p1__35240_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__35240_SHARP_));
});})(matches,vec__35244,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__35247){
var vec__35254 = p__35247;
...
var tag = first__35256;
var content = seq__35255__$1;
...
var vec__35257 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35257,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35257,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35257,(2),null);
