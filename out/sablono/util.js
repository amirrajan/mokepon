...
var x__19391__auto__ = (((x == null))?null:x);
var m__19392__auto__ = (sablono.util.to_str[goog.typeOf(x__19391__auto__)]);
if(!((m__19392__auto__ == null))){
return (m__19392__auto__.cljs$core$IFn$_invoke$arity$1 ? m__19392__auto__.cljs$core$IFn$_invoke$arity$1(x) : m__19392__auto__.call(null,x));
} else {
var m__19392__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__19392__auto____$1 == null))){
return (m__19392__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__19392__auto____$1.cljs$core$IFn$_invoke$arity$1(x) : m__19392__auto____$1.call(null,x));
} else {
...
var x__19391__auto__ = (((x == null))?null:x);
var m__19392__auto__ = (sablono.util.to_uri[goog.typeOf(x__19391__auto__)]);
if(!((m__19392__auto__ == null))){
return (m__19392__auto__.cljs$core$IFn$_invoke$arity$1 ? m__19392__auto__.cljs$core$IFn$_invoke$arity$1(x) : m__19392__auto__.call(null,x));
} else {
var m__19392__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__19392__auto____$1 == null))){
return (m__19392__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__19392__auto____$1.cljs$core$IFn$_invoke$arity$1(x) : m__19392__auto____$1.call(null,x));
} else {
...
var len__19803__auto___27882 = arguments.length;
var i__19804__auto___27883 = (0);
while(true){
if((i__19804__auto___27883 < len__19803__auto___27882)){
args__19810__auto__.push((arguments[i__19804__auto___27883]));

var G__27884 = (i__19804__auto___27883 + (1));
i__19804__auto___27883 = G__27884;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__19811__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq27881){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27881));
});
...
var vec__27888 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
...
var first_word = first__27890;
var words = seq__27889__$1;
...
var G__27892 = clojure.set.rename_keys(m,kmap);
if(cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__27892,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono$util$camel_case_keys);
} else {
return G__27892;
}
} else {
...
var args__19810__auto__ = [];
var len__19803__auto___27895 = arguments.length;
var i__19804__auto___27896 = (0);
while(true){
if((i__19804__auto___27896 < len__19803__auto___27895)){
args__19810__auto__.push((arguments[i__19804__auto___27896]));

var G__27897 = (i__19804__auto___27896 + (1));
i__19804__auto___27896 = G__27897;
continue;
} else {
}
break;
...
var argseq__19811__auto__ = ((((0) < args__19810__auto__.length))?(new cljs.core.IndexedSeq(args__19810__auto__.slice((0)),(0),null)):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__19811__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__27893_SHARP_){
if(cljs.core.list_QMARK_(p1__27893_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__27893_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__27893_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq27894){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27894));
});
...
var vec__27903 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27903,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27903,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__27903,tag_name,names){
return (function (p1__27898_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__27898_SHARP_));
});})(matches,vec__27903,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__27903,tag_name,names){
return (function (p1__27899_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__27899_SHARP_));
});})(matches,vec__27903,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__27906){
var vec__27913 = p__27906;
...
var tag = first__27915;
var content = seq__27914__$1;
...
var vec__27916 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27916,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27916,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27916,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__18728__auto__ = x__$1.hasDomain();
