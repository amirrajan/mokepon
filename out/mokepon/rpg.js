...
return cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$team_DASH_at_DASH_home,cljs.core.cst$kw$play_DASH_by_DASH_play,cljs.core.cst$kw$battling,cljs.core.cst$kw$cash,cljs.core.cst$kw$messages,cljs.core.cst$kw$team,cljs.core.cst$kw$mokedex,cljs.core.cst$kw$items,cljs.core.cst$kw$location,cljs.core.cst$kw$chosen_DASH_key],[cljs.core.PersistentVector.EMPTY,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [""], null),null,(100),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$mom,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$text,"Where are you? Have you found a job yet?!",cljs.core.cst$kw$day,(0)], null)], null)], null),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$monsters,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__69998_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__69998_SHARP_,cljs.core.cst$kw$captured,false,cljs.core.array_seq([cljs.core.cst$kw$encountered,false], 0));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70003){
var vec__70004 = p__70003;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70004,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70004,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(v) : f.call(null,v))], null);
}),dict));
});
mokepon.rpg.filter_key = (function mokepon$rpg$filter_key(predicate,dict){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70015){
var vec__70016 = p__70015;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70016,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70016,(1),null);
return k;
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__70019){
var vec__70020 = p__70019;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70020,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70020,(1),null);
...
if(cljs.core.truth_((function (){var G__70024 = cljs.core.first(items);
return (predicate.cljs$core$IFn$_invoke$arity$1 ? predicate.cljs$core$IFn$_invoke$arity$1(G__70024) : predicate.call(null,G__70024));
})())){
return idx;
} else {
var G__70025 = (idx + (1));
var G__70026 = cljs.core.rest(items);
idx = G__70025;
items = G__70026;
continue;
...
var or__28012__auto____$2 = (cljs.core.cst$kw$hp.cljs$core$IFn$_invoke$arity$1(chosen) <= (0));
if(or__28012__auto____$2){
return or__28012__auto____$2;
} else {
var or__28012__auto____$3 = (cljs.core.cst$kw$hp.cljs$core$IFn$_invoke$arity$1(battling) <= (0));
...
var len__29087__auto___70029 = arguments.length;
var i__29088__auto___70030 = (0);
while(true){
if((i__29088__auto___70030 < len__29087__auto___70029)){
args__29094__auto__.push((arguments[i__29088__auto___70030]));

var G__70031 = (i__29088__auto___70030 + (1));
i__29088__auto___70030 = G__70031;
continue;
} else {
}
break;
...
return mokepon.rpg.conj_play_by_play.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29095__auto__);
});
...
mokepon.rpg.conj_play_by_play.cljs$lang$applyTo = (function (seq70027){
var G__70028 = cljs.core.first(seq70027);
var seq70027__$1 = cljs.core.next(seq70027);
return mokepon.rpg.conj_play_by_play.cljs$core$IFn$_invoke$arity$variadic(G__70028,seq70027__$1);
});
...
mokepon.rpg.active_turn_percentage = (function mokepon$rpg$active_turn_percentage(p__70032,monster){
var map__70035 = p__70032;
var map__70035__$1 = ((((!((map__70035 == null)))?((((map__70035.cljs$lang$protocol_mask$partition0$ & (64))) || (map__70035.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70035):map__70035);
var at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70035__$1,cljs.core.cst$kw$at);
...
var or__28012__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(game_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$items,item_key], null));
...
return (function (p1__70037_SHARP_){
var x__28350__auto__ = cljs.core.cst$kw$max_DASH_hp.cljs$core$IFn$_invoke$arity$1(mokepon.rpg.chosen_monster(game_state));
var y__28351__auto__ = (p1__70037_SHARP_ + (10));
...
return (function (p1__70038_SHARP_){
return ((function (){var or__28012__auto__ = p1__70038_SHARP_;
if(cljs.core.truth_(or__28012__auto__)){
return or__28012__auto__;
} else {
return (0);
...
return (function (p1__70039_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(monster_id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__70039_SHARP_));
...
return (function (p1__70040_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__70040_SHARP_,cljs.core.cst$kw$captured,true,cljs.core.array_seq([cljs.core.cst$kw$encountered,true], 0));
...
var map__70043 = battling;
var map__70043__$1 = ((((!((map__70043 == null)))?((((map__70043.cljs$lang$protocol_mask$partition0$ & (64))) || (map__70043.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70043):map__70043);
var max_hp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70043__$1,cljs.core.cst$kw$max_DASH_hp);
var hp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70043__$1,cljs.core.cst$kw$hp);
...
var or__28012__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(mokepon.rpg.affinities,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from_type,to_type], null));
if(cljs.core.truth_(or__28012__auto__)){
return or__28012__auto__;
} else {
return 1.0;
...
var map__70047 = mokepon.rpg.try_attack(chosen,battling);
var map__70047__$1 = ((((!((map__70047 == null)))?((((map__70047.cljs$lang$protocol_mask$partition0$ & (64))) || (map__70047.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70047):map__70047);
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70047__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70047__$1,cljs.core.cst$kw$to);
var attack_occured_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70047__$1,cljs.core.cst$kw$attack_DASH_occured_QMARK_);
...
var map__70051 = attack_result;
var map__70051__$1 = ((((!((map__70051 == null)))?((((map__70051.cljs$lang$protocol_mask$partition0$ & (64))) || (map__70051.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70051):map__70051);
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70051__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70051__$1,cljs.core.cst$kw$to);
var attack_occured_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70051__$1,cljs.core.cst$kw$attack_DASH_occured_QMARK_);
...
return mokepon.rpg.filter_key((function (p1__70053_SHARP_){
return cljs.core.not(mokepon.rpg.is_dead_QMARK_(p1__70053_SHARP_));
}),team);
});
...
var need_to_auto_swap = (function (){var and__28000__auto__ = mokepon.rpg.is_dead_QMARK_(chosen);
...
var map__70056 = mokepon.rpg.try_attack(battling_ticked,chosen_ticked);
var map__70056__$1 = ((((!((map__70056 == null)))?((((map__70056.cljs$lang$protocol_mask$partition0$ & (64))) || (map__70056.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70056):map__70056);
var attack_result = map__70056__$1;
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70056__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70056__$1,cljs.core.cst$kw$to);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70066){
var vec__70067 = p__70066;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70067,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70067,(1),null);
return k;
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__70070){
var vec__70071 = p__70070;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70071,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70071,(1),null);
return mokepon.rpg.is_dead_QMARK_(v);
}),cljs.core.cst$kw$team.cljs$core$IFn$_invoke$arity$1(game_state)));
});
mokepon.rpg.text_from_mom = (function mokepon$rpg$text_from_mom(game_state){
if(cljs.core.empty_QMARK_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(game_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$team], null)))){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(game_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$messages,cljs.core.cst$kw$mom], null),(function (p1__70074_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__70074_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$text,"You lost all of your Mok\u00E9pon didn't you? Worthless. Come by and I'll give you another Chipu.",cljs.core.cst$kw$day,(0)], null));
}));
} else {
return game_state;
}
...
return (function (p1__70075_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__70075_SHARP_,dead_keys);
});})(dead_keys))
);
return mokepon.rpg.text_from_mom(mokepon.rpg.mark_captured_in_mokedex(new_state,dead_keys));
});
...
return (function (){
return ((function (){var or__28012__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(game_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$items,item_id], null));
if(cljs.core.truth_(or__28012__auto__)){
return or__28012__auto__;
} else {
return (0);
...
return (function (p1__70076_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(monster_id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__70076_SHARP_));
});})(mokedex_monsters))
,mokedex_monsters);
var path = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$mokedex,cljs.core.cst$kw$monsters,mokedex_index], null);
if(cljs.core.truth_(mokedex_index)){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(game_state,path,((function (mokedex_monsters,mokedex_index,path){
return (function (p1__70077_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__70077_SHARP_,cljs.core.cst$kw$encountered,true);
