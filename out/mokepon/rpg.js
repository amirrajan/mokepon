...
return cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$team_DASH_at_DASH_home,cljs.core.cst$kw$play_DASH_by_DASH_play,cljs.core.cst$kw$battling,cljs.core.cst$kw$cash,cljs.core.cst$kw$messages,cljs.core.cst$kw$team,cljs.core.cst$kw$mokedex,cljs.core.cst$kw$items,cljs.core.cst$kw$location,cljs.core.cst$kw$chosen_DASH_key],[cljs.core.PersistentVector.EMPTY,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["You sit outside, unemployed."], null),null,(100),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$from,cljs.core.cst$kw$mom,cljs.core.cst$kw$text,"Where are you? Have you found a job yet?! Come by the house. I have a Chipu for you. Maybe you can make some money with it.",cljs.core.cst$kw$day,(0),cljs.core.cst$kw$seen_QMARK_,false], null)], null),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$monsters,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27355_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__27355_SHARP_,cljs.core.cst$kw$captured,false,cljs.core.array_seq([cljs.core.cst$kw$encountered,false], 0));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__27360){
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__27372){
...
return k;
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__27376){
...
if(cljs.core.truth_((function (){var G__27381 = cljs.core.first(items);
return (predicate.cljs$core$IFn$_invoke$arity$1 ? predicate.cljs$core$IFn$_invoke$arity$1(G__27381) : predicate.call(null,G__27381));
})())){
return idx;
} else {
var G__27382 = (idx + (1));
var G__27383 = cljs.core.rest(items);
idx = G__27382;
items = G__27383;
continue;
...
var len__19539__auto___27386 = arguments.length;
var i__19540__auto___27387 = (0);
while(true){
if((i__19540__auto___27387 < len__19539__auto___27386)){
args__19546__auto__.push((arguments[i__19540__auto___27387]));

var G__27388 = (i__19540__auto___27387 + (1));
i__19540__auto___27387 = G__27388;
continue;
} else {
}
break;
...
mokepon.rpg.conj_play_by_play.cljs$lang$applyTo = (function (seq27384){
var G__27385 = cljs.core.first(seq27384);
var seq27384__$1 = cljs.core.next(seq27384);
return mokepon.rpg.conj_play_by_play.cljs$core$IFn$_invoke$arity$variadic(G__27385,seq27384__$1);
});
...
mokepon.rpg.active_turn_percentage = (function mokepon$rpg$active_turn_percentage(p__27389,monster){
var map__27392 = p__27389;
var map__27392__$1 = ((((!((map__27392 == null)))?((((map__27392.cljs$lang$protocol_mask$partition0$ & (64))) || (map__27392.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27392):map__27392);
var at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27392__$1,cljs.core.cst$kw$at);
...
var y__18803__auto__ = (p1__27394_SHARP_ + (10));
...
return ((function (){var or__18464__auto__ = p1__27395_SHARP_;
if(cljs.core.truth_(or__18464__auto__)){
return or__18464__auto__;
} else {
return (0);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(monster_id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__27396_SHARP_));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__27397_SHARP_,cljs.core.cst$kw$captured,true,cljs.core.array_seq([cljs.core.cst$kw$encountered,true], 0));
...
var map__27400 = battling;
var map__27400__$1 = ((((!((map__27400 == null)))?((((map__27400.cljs$lang$protocol_mask$partition0$ & (64))) || (map__27400.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27400):map__27400);
var max_hp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27400__$1,cljs.core.cst$kw$max_DASH_hp);
var hp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27400__$1,cljs.core.cst$kw$hp);
...
var map__27404 = mokepon.rpg.try_attack(chosen,battling);
var map__27404__$1 = ((((!((map__27404 == null)))?((((map__27404.cljs$lang$protocol_mask$partition0$ & (64))) || (map__27404.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27404):map__27404);
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27404__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27404__$1,cljs.core.cst$kw$to);
var attack_occured_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27404__$1,cljs.core.cst$kw$attack_DASH_occured_QMARK_);
...
var map__27408 = attack_result;
var map__27408__$1 = ((((!((map__27408 == null)))?((((map__27408.cljs$lang$protocol_mask$partition0$ & (64))) || (map__27408.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27408):map__27408);
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27408__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27408__$1,cljs.core.cst$kw$to);
var attack_occured_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27408__$1,cljs.core.cst$kw$attack_DASH_occured_QMARK_);
...
return mokepon.rpg.filter_key((function (p1__27410_SHARP_){
return cljs.core.not(mokepon.rpg.is_dead_QMARK_(p1__27410_SHARP_));
}),team);
});
...
var map__27413 = mokepon.rpg.try_attack(battling_ticked,chosen_ticked);
var map__27413__$1 = ((((!((map__27413 == null)))?((((map__27413.cljs$lang$protocol_mask$partition0$ & (64))) || (map__27413.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27413):map__27413);
var attack_result = map__27413__$1;
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27413__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27413__$1,cljs.core.cst$kw$to);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__27423){
var vec__27424 = p__27423;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27424,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27424,(1),null);
return k;
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__27427){
var vec__27428 = p__27427;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27428,(0),null);
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(game_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$messages], null),(function (p1__27431_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__27431_SHARP_,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$from,cljs.core.cst$kw$mom,cljs.core.cst$kw$text,"You lost all of your Mok\u00E9pon didn't you? Worthless. Come by and I'll give you another Chipu.",cljs.core.cst$kw$day,(0),cljs.core.cst$kw$seen_QMARK_,false], null));
}));
} else {
return game_state;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__27432_SHARP_,dead_keys);
});})(dead_keys))
);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(monster_id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__27433_SHARP_));
});})(mokedex_monsters))
,mokedex_monsters);
var path = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$mokedex,cljs.core.cst$kw$monsters,mokedex_index], null);
if(cljs.core.truth_(mokedex_index)){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__27434_SHARP_,cljs.core.cst$kw$encountered,true);
...
return cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27435_SHARP_){
return cljs.core.not(cljs.core.cst$kw$seen_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__27435_SHARP_));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27436_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__27436_SHARP_,cljs.core.cst$kw$seen_QMARK_,true);
}),messages);
}));
});
