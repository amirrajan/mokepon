...
return cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$team_DASH_at_DASH_home,cljs.core.cst$kw$play_DASH_by_DASH_play,cljs.core.cst$kw$battling,cljs.core.cst$kw$cash,cljs.core.cst$kw$messages,cljs.core.cst$kw$team,cljs.core.cst$kw$mokedex,cljs.core.cst$kw$items,cljs.core.cst$kw$location,cljs.core.cst$kw$chosen_DASH_key,cljs.core.cst$kw$locations_DASH_seen],[cljs.core.PersistentVector.EMPTY,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["You sit outside, unemployed."], null),null,(100),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$from,cljs.core.cst$kw$mom,cljs.core.cst$kw$text,"Where are you? Have you found a job yet?! Come by the house. I have a Chipu for you. Maybe you can make some money with it.",cljs.core.cst$kw$day,(0),cljs.core.cst$kw$seen_QMARK_,false], null)], null),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$monsters,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31180_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__31180_SHARP_,cljs.core.cst$kw$captured,false,cljs.core.array_seq([cljs.core.cst$kw$encountered,false], 0));
}),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [mokepon.monsters.chipu,mokepon.monsters.tirsqule,mokepon.monsters.sulbabaur,mokepon.monsters.deogude], null)))], null),cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$outside,null,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$phone,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$seen_QMARK_,false], null),cljs.core.cst$kw$home,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$seen_QMARK_,false], null),cljs.core.cst$kw$shop,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$seen_QMARK_,false], null),cljs.core.cst$kw$canyon,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$seen_QMARK_,false], null),cljs.core.cst$kw$forest,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$seen_QMARK_,false], null),cljs.core.cst$kw$lake,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$seen_QMARK_,false], null)], null)]);
});
mokepon.rpg.apply_to_all_values = (function mokepon$rpg$apply_to_all_values(f,dict){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__31185){
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__31197){
...
return k;
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__31201){
...
if(cljs.core.truth_((function (){var G__31206 = cljs.core.first(items);
return (predicate.cljs$core$IFn$_invoke$arity$1 ? predicate.cljs$core$IFn$_invoke$arity$1(G__31206) : predicate.call(null,G__31206));
})())){
return idx;
} else {
var G__31207 = (idx + (1));
var G__31208 = cljs.core.rest(items);
idx = G__31207;
items = G__31208;
continue;
...
var len__19539__auto___31211 = arguments.length;
var i__19540__auto___31212 = (0);
while(true){
if((i__19540__auto___31212 < len__19539__auto___31211)){
args__19546__auto__.push((arguments[i__19540__auto___31212]));

var G__31213 = (i__19540__auto___31212 + (1));
i__19540__auto___31212 = G__31213;
continue;
} else {
}
break;
...
mokepon.rpg.conj_play_by_play.cljs$lang$applyTo = (function (seq31209){
var G__31210 = cljs.core.first(seq31209);
var seq31209__$1 = cljs.core.next(seq31209);
return mokepon.rpg.conj_play_by_play.cljs$core$IFn$_invoke$arity$variadic(G__31210,seq31209__$1);
});
...
mokepon.rpg.active_turn_percentage = (function mokepon$rpg$active_turn_percentage(p__31214,monster){
var map__31217 = p__31214;
var map__31217__$1 = ((((!((map__31217 == null)))?((((map__31217.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31217.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31217):map__31217);
var at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31217__$1,cljs.core.cst$kw$at);
...
var y__18803__auto__ = (p1__31219_SHARP_ + (10));
...
return ((function (){var or__18464__auto__ = p1__31220_SHARP_;
if(cljs.core.truth_(or__18464__auto__)){
return or__18464__auto__;
} else {
return (0);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(monster_id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__31221_SHARP_));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__31222_SHARP_,cljs.core.cst$kw$captured,true,cljs.core.array_seq([cljs.core.cst$kw$encountered,true], 0));
...
var map__31225 = battling;
var map__31225__$1 = ((((!((map__31225 == null)))?((((map__31225.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31225.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31225):map__31225);
var max_hp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31225__$1,cljs.core.cst$kw$max_DASH_hp);
var hp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31225__$1,cljs.core.cst$kw$hp);
...
var map__31229 = mokepon.rpg.try_attack(chosen,battling);
var map__31229__$1 = ((((!((map__31229 == null)))?((((map__31229.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31229.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31229):map__31229);
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31229__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31229__$1,cljs.core.cst$kw$to);
var attack_occured_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31229__$1,cljs.core.cst$kw$attack_DASH_occured_QMARK_);
...
var map__31233 = attack_result;
var map__31233__$1 = ((((!((map__31233 == null)))?((((map__31233.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31233.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31233):map__31233);
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31233__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31233__$1,cljs.core.cst$kw$to);
var attack_occured_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31233__$1,cljs.core.cst$kw$attack_DASH_occured_QMARK_);
...
return mokepon.rpg.filter_key((function (p1__31235_SHARP_){
return cljs.core.not(mokepon.rpg.is_dead_QMARK_(p1__31235_SHARP_));
}),team);
});
...
var map__31238 = mokepon.rpg.try_attack(battling_ticked,chosen_ticked);
var map__31238__$1 = ((((!((map__31238 == null)))?((((map__31238.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31238.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31238):map__31238);
var attack_result = map__31238__$1;
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31238__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31238__$1,cljs.core.cst$kw$to);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__31248){
...
return k;
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__31252){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(game_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$messages], null),(function (p1__31256_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__31256_SHARP_,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$from,cljs.core.cst$kw$mom,cljs.core.cst$kw$text,"Did your Chipu get killed? Worthless. Come by and I'll give you another one.",cljs.core.cst$kw$day,(0),cljs.core.cst$kw$seen_QMARK_,false], null));
}));
} else {
return game_state;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__31257_SHARP_,dead_keys);
});})(dead_keys))
);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(monster_id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__31258_SHARP_));
});})(mokedex_monsters))
,mokedex_monsters);
var path = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$mokedex,cljs.core.cst$kw$monsters,mokedex_index], null);
if(cljs.core.truth_(mokedex_index)){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__31259_SHARP_,cljs.core.cst$kw$encountered,true);
...
return cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__31260_SHARP_){
return cljs.core.not(cljs.core.cst$kw$seen_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__31260_SHARP_));
}),cljs.core.cst$kw$messages.cljs$core$IFn$_invoke$arity$1(game_state)));
});
mokepon.rpg.mark_messages_as_read = (function mokepon$rpg$mark_messages_as_read(game_state){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(game_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$messages], null),(function (messages){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31261_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__31261_SHARP_,cljs.core.cst$kw$seen_QMARK_,true);
}),messages);
}));
});
