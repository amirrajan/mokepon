...
return true;
})], null),cljs.core.cst$kw$store,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$description,"There is a Mok\u00E9pon store with a half working neon sign flashing. Looks kinda shady.",cljs.core.cst$kw$action,"Go shop.",cljs.core.cst$kw$available_DASH_if,mokepon.locations.captured_monsters_gt_eq((1))], null),cljs.core.cst$kw$canyon,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$description,"There is a rock face jutting out. It looks freaking scary.",cljs.core.cst$kw$action,"Go be awesome in the canyon.",cljs.core.cst$kw$available_DASH_if,mokepon.locations.captured_monsters_gt_eq((1))], null),cljs.core.cst$kw$forest,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$description,"There is a line of trees off in the distance.",cljs.core.cst$kw$action,"Go be awesome in the forest.",cljs.core.cst$kw$available_DASH_if,mokepon.locations.captured_monsters_gt_eq((1))], null),cljs.core.cst$kw$pool,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$description,"The neighborhood pool hasn't been cleaned in a while. Smells like poop.",cljs.core.cst$kw$action,"Go be awesome in the pool.",cljs.core.cst$kw$available_DASH_if,mokepon.locations.captured_monsters_gt_eq((1))], null)], null);
});
