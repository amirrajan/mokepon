...
return mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,header], null),((cljs.core.empty_QMARK_(team))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p,empty_text], null):null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul,(function (){var iter__19244__auto__ = (function mokepon$components$team_view_$_iter__37801(s__37802){
return (new cljs.core.LazySeq(null,(function (){
var s__37802__$1 = s__37802;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__37802__$1);
if(temp__4657__auto__){
var s__37802__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37802__$2)){
var c__19242__auto__ = cljs.core.chunk_first(s__37802__$2);
var size__19243__auto__ = cljs.core.count(c__19242__auto__);
var b__37804 = cljs.core.chunk_buffer(size__19243__auto__);
if((function (){var i__37803 = (0);
while(true){
if((i__37803 < size__19243__auto__)){
var vec__37813 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__19242__auto__,i__37803);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37804),mokepon$components$team_view_$_iter__37801(cljs.core.chunk_rest(s__37802__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37804),null);
}
} else {
var vec__37816 = cljs.core.first(s__37802__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(v)], null),[cljs.core.str(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(v)),cljs.core.str(" (hp: "),cljs.core.str(cljs.core.cst$kw$hp.cljs$core$IFn$_invoke$arity$1(v)),cljs.core.str("/"),cljs.core.str(cljs.core.cst$kw$max_DASH_hp.cljs$core$IFn$_invoke$arity$1(v)),cljs.core.str(")")].join('')], null),mokepon$components$team_view_$_iter__37801(cljs.core.rest(s__37802__$2)));
}
} else {
return null;
}
...
return mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([(function (){var iter__19244__auto__ = (function mokepon$components$play_by_play_view_$_iter__37826(s__37827){
return (new cljs.core.LazySeq(null,(function (){
var s__37827__$1 = s__37827;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__37827__$1);
if(temp__4657__auto__){
var s__37827__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37827__$2)){
var c__19242__auto__ = cljs.core.chunk_first(s__37827__$2);
var size__19243__auto__ = cljs.core.count(c__19242__auto__);
var b__37829 = cljs.core.chunk_buffer(size__19243__auto__);
if((function (){var i__37828 = (0);
while(true){
if((i__37828 < size__19243__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__19242__auto__,i__37828);
cljs.core.chunk_append(b__37829,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,i], null));

var G__37832 = (i__37828 + (1));
i__37828 = G__37832;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37829),mokepon$components$play_by_play_view_$_iter__37826(cljs.core.chunk_rest(s__37827__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37829),null);
}
} else {
var i = cljs.core.first(s__37827__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,i], null),mokepon$components$play_by_play_view_$_iter__37826(cljs.core.rest(s__37827__$2)));
}
} else {
return null;
}
...
return mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p,[cljs.core.str("You walk into the store. A midget stands behind the counter on a stool. "),cljs.core.str("He occasionally props himself up with locked arms and dangles his feet in the air.")].join('')], null),(function (){var iter__19244__auto__ = (function mokepon$components$store_view_$_iter__37843(s__37844){
return (new cljs.core.LazySeq(null,(function (){
var s__37844__$1 = s__37844;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__37844__$1);
if(temp__4657__auto__){
var s__37844__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37844__$2)){
var c__19242__auto__ = cljs.core.chunk_first(s__37844__$2);
var size__19243__auto__ = cljs.core.count(c__19242__auto__);
var b__37846 = cljs.core.chunk_buffer(size__19243__auto__);
if((function (){var i__37845 = (0);
while(true){
if((i__37845 < size__19243__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__19242__auto__,i__37845);
cljs.core.chunk_append(b__37846,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$a,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$margin,(0),cljs.core.cst$kw$padding,(0)], null),cljs.core.cst$kw$href,"javascript:;",cljs.core.cst$kw$on_DASH_click,((function (i__37845,item,c__19242__auto__,size__19243__auto__,b__37846,s__37844__$2,temp__4657__auto__){
return (function (){
var G__37851 = cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(item);
return (buy_item_handler.cljs$core$IFn$_invoke$arity$1 ? buy_item_handler.cljs$core$IFn$_invoke$arity$1(G__37851) : buy_item_handler.call(null,G__37851));
});})(i__37845,item,c__19242__auto__,size__19243__auto__,b__37846,s__37844__$2,temp__4657__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37846),mokepon$components$store_view_$_iter__37843(cljs.core.chunk_rest(s__37844__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37846),null);
}
} else {
var item = cljs.core.first(s__37844__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$a,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$margin,(0),cljs.core.cst$kw$padding,(0)], null),cljs.core.cst$kw$href,"javascript:;",cljs.core.cst$kw$on_DASH_click,((function (item,s__37844__$2,temp__4657__auto__){
return (function (){
var G__37852 = cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(item);
return (buy_item_handler.cljs$core$IFn$_invoke$arity$1 ? buy_item_handler.cljs$core$IFn$_invoke$arity$1(G__37852) : buy_item_handler.call(null,G__37852));
});})(item,s__37844__$2,temp__4657__auto__))
], null),[cljs.core.str("Buy "),cljs.core.str(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(item)),cljs.core.str(" ("),cljs.core.str(cljs.core.cst$kw$cost.cljs$core$IFn$_invoke$arity$1(item)),cljs.core.str(" \u0191iddy)")].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$margin,(0),cljs.core.cst$kw$padding,(0),cljs.core.cst$kw$margin_DASH_bottom,"10px",cljs.core.cst$kw$font_DASH_size,"smaller"], null)], null),cljs.core.cst$kw$description.cljs$core$IFn$_invoke$arity$1(item)], null)], null),mokepon$components$store_view_$_iter__37843(cljs.core.rest(s__37844__$2)));
}
} else {
return null;
}
...
var map__37893 = game_state;
var map__37893__$1 = ((((!((map__37893 == null)))?((((map__37893.cljs$lang$protocol_mask$partition0$ & (64))) || (map__37893.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37893):map__37893);
var location = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37893__$1,cljs.core.cst$kw$location);
var team = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37893__$1,cljs.core.cst$kw$team);
var team_at_home = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37893__$1,cljs.core.cst$kw$team_DASH_at_DASH_home);
var battling = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37893__$1,cljs.core.cst$kw$battling);
var cash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37893__$1,cljs.core.cst$kw$cash);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37893__$1,cljs.core.cst$kw$items);
var play_by_play = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37893__$1,cljs.core.cst$kw$play_DASH_by_DASH_play);
var mokedex = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37893__$1,cljs.core.cst$kw$mokedex);
