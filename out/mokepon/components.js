...
return mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,header], null),((cljs.core.empty_QMARK_(team))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p,empty_text], null):null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul,(function (){var iter__19244__auto__ = (function mokepon$components$team_view_$_iter__27183(s__27184){
return (new cljs.core.LazySeq(null,(function (){
var s__27184__$1 = s__27184;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__27184__$1);
if(temp__4657__auto__){
var s__27184__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27184__$2)){
var c__19242__auto__ = cljs.core.chunk_first(s__27184__$2);
var size__19243__auto__ = cljs.core.count(c__19242__auto__);
var b__27186 = cljs.core.chunk_buffer(size__19243__auto__);
if((function (){var i__27185 = (0);
while(true){
if((i__27185 < size__19243__auto__)){
var vec__27195 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__19242__auto__,i__27185);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27186),mokepon$components$team_view_$_iter__27183(cljs.core.chunk_rest(s__27184__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27186),null);
}
} else {
var vec__27198 = cljs.core.first(s__27184__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(v)], null),[cljs.core.str(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(v)),cljs.core.str(" (hp: "),cljs.core.str(cljs.core.cst$kw$hp.cljs$core$IFn$_invoke$arity$1(v)),cljs.core.str("/"),cljs.core.str(cljs.core.cst$kw$max_DASH_hp.cljs$core$IFn$_invoke$arity$1(v)),cljs.core.str(")")].join('')], null),mokepon$components$team_view_$_iter__27183(cljs.core.rest(s__27184__$2)));
}
} else {
return null;
}
...
return mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([(function (){var iter__19244__auto__ = (function mokepon$components$play_by_play_view_$_iter__27208(s__27209){
return (new cljs.core.LazySeq(null,(function (){
var s__27209__$1 = s__27209;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__27209__$1);
if(temp__4657__auto__){
var s__27209__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27209__$2)){
var c__19242__auto__ = cljs.core.chunk_first(s__27209__$2);
var size__19243__auto__ = cljs.core.count(c__19242__auto__);
var b__27211 = cljs.core.chunk_buffer(size__19243__auto__);
if((function (){var i__27210 = (0);
while(true){
if((i__27210 < size__19243__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__19242__auto__,i__27210);
cljs.core.chunk_append(b__27211,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,i], null));

var G__27214 = (i__27210 + (1));
i__27210 = G__27214;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27211),mokepon$components$play_by_play_view_$_iter__27208(cljs.core.chunk_rest(s__27209__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27211),null);
}
} else {
var i = cljs.core.first(s__27209__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,i], null),mokepon$components$play_by_play_view_$_iter__27208(cljs.core.rest(s__27209__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p,"Messages"], null)], 0)),mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul$messages,(function (){var iter__19244__auto__ = (function mokepon$components$messages_view_$_iter__27221(s__27222){
return (new cljs.core.LazySeq(null,(function (){
var s__27222__$1 = s__27222;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__27222__$1);
if(temp__4657__auto__){
var s__27222__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27222__$2)){
var c__19242__auto__ = cljs.core.chunk_first(s__27222__$2);
var size__19243__auto__ = cljs.core.count(c__19242__auto__);
var b__27224 = cljs.core.chunk_buffer(size__19243__auto__);
if((function (){var i__27223 = (0);
while(true){
if((i__27223 < size__19243__auto__)){
var m = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__19242__auto__,i__27223);
cljs.core.chunk_append(b__27224,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,[cljs.core.str(cljs.core.cst$kw$from.cljs$core$IFn$_invoke$arity$1(m).call(null,mokepon.components.message_from())),cljs.core.str(": "),cljs.core.str(cljs.core.cst$kw$text.cljs$core$IFn$_invoke$arity$1(m))].join('')], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$br], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$font_DASH_size,cljs.core.cst$kw$smaller], null)], null),"0 day(s) ago"], null)], null)], null));

var G__27227 = (i__27223 + (1));
i__27223 = G__27227;
continue;
} else {
return true;
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p,"Outside"], null)], 0)),mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([(function (){var iter__19244__auto__ = (function mokepon$components$outside_view_$_iter__27234(s__27235){
return (new cljs.core.LazySeq(null,(function (){
var s__27235__$1 = s__27235;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__27235__$1);
if(temp__4657__auto__){
var s__27235__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27235__$2)){
var c__19242__auto__ = cljs.core.chunk_first(s__27235__$2);
var size__19243__auto__ = cljs.core.count(c__19242__auto__);
var b__27237 = cljs.core.chunk_buffer(size__19243__auto__);
if((function (){var i__27236 = (0);
while(true){
if((i__27236 < size__19243__auto__)){
var loc = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__19242__auto__,i__27236);
cljs.core.chunk_append(b__27237,(cljs.core.truth_((location_available_handler.cljs$core$IFn$_invoke$arity$1 ? location_available_handler.cljs$core$IFn$_invoke$arity$1(loc) : location_available_handler.call(null,loc)))?mokepon.components.adventure_view(cljs.core.cst$kw$description.cljs$core$IFn$_invoke$arity$1((loc.cljs$core$IFn$_invoke$arity$1 ? loc.cljs$core$IFn$_invoke$arity$1(location_info) : loc.call(null,location_info))),cljs.core.cst$kw$action.cljs$core$IFn$_invoke$arity$1((loc.cljs$core$IFn$_invoke$arity$1 ? loc.cljs$core$IFn$_invoke$arity$1(location_info) : loc.call(null,location_info))),loc,go_to_location_handler):null));

var G__27240 = (i__27236 + (1));
i__27236 = G__27240;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27237),mokepon$components$outside_view_$_iter__27234(cljs.core.chunk_rest(s__27235__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27237),null);
}
} else {
var loc = cljs.core.first(s__27235__$2);
return cljs.core.cons((cljs.core.truth_((location_available_handler.cljs$core$IFn$_invoke$arity$1 ? location_available_handler.cljs$core$IFn$_invoke$arity$1(loc) : location_available_handler.call(null,loc)))?mokepon.components.adventure_view(cljs.core.cst$kw$description.cljs$core$IFn$_invoke$arity$1((loc.cljs$core$IFn$_invoke$arity$1 ? loc.cljs$core$IFn$_invoke$arity$1(location_info) : loc.call(null,location_info))),cljs.core.cst$kw$action.cljs$core$IFn$_invoke$arity$1((loc.cljs$core$IFn$_invoke$arity$1 ? loc.cljs$core$IFn$_invoke$arity$1(location_info) : loc.call(null,location_info))),loc,go_to_location_handler):null),mokepon$components$outside_view_$_iter__27234(cljs.core.rest(s__27235__$2)));
}
} else {
return null;
}
...
cljs.core.chunk_append(b__27262,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,[cljs.core.str(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1((k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(shop_items_lookup) : k.call(null,shop_items_lookup)))),cljs.core.str(": "),cljs.core.str(v)].join('')], null));

var G__27277 = (i__27261 + (1));
i__27261 = G__27277;
continue;
} else {
return true;
...
var map__27280 = game_state;
var map__27280__$1 = ((((!((map__27280 == null)))?((((map__27280.cljs$lang$protocol_mask$partition0$ & (64))) || (map__27280.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27280):map__27280);
var location = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27280__$1,cljs.core.cst$kw$location);
var team = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27280__$1,cljs.core.cst$kw$team);
var team_at_home = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27280__$1,cljs.core.cst$kw$team_DASH_at_DASH_home);
var battling = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27280__$1,cljs.core.cst$kw$battling);
var cash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27280__$1,cljs.core.cst$kw$cash);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27280__$1,cljs.core.cst$kw$items);
var play_by_play = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27280__$1,cljs.core.cst$kw$play_DASH_by_DASH_play);
var mokedex = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27280__$1,cljs.core.cst$kw$mokedex);
var messages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27280__$1,cljs.core.cst$kw$messages);
