...
var G__27488 = mokepon.container.app_state();
return (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(G__27488) : cljs.core.deref.call(null,G__27488));
});
...
var G__27491_27493 = mokepon.container.app_state();
var G__27492_27494 = mokepon.rpg.new_game();
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__27491_27493,G__27492_27494) : cljs.core.reset_BANG_.call(null,G__27491_27493,G__27492_27494));
...
}catch (e27496){var t__23091__auto__ = e27496;
...
var len__19539__auto___27498 = arguments.length;
var i__19540__auto___27499 = (0);
while(true){
if((i__19540__auto___27499 < len__19539__auto___27498)){
args__19546__auto__.push((arguments[i__19540__auto___27499]));

var G__27500 = (i__19540__auto___27499 + (1));
i__19540__auto___27499 = G__27500;
continue;
} else {
}
break;
...
mokepon.tests.core.get_state.cljs$lang$applyTo = (function (seq27497){
return mokepon.tests.core.get_state.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27497));
});

mokepon.tests.core.log_state = (function mokepon$tests$core$log_state(var_args){
var args__19546__auto__ = [];
var len__19539__auto___27502 = arguments.length;
var i__19540__auto___27503 = (0);
while(true){
if((i__19540__auto___27503 < len__19539__auto___27502)){
args__19546__auto__.push((arguments[i__19540__auto___27503]));

var G__27504 = (i__19540__auto___27503 + (1));
i__19540__auto___27503 = G__27504;
continue;
} else {
}
break;
...
mokepon.tests.core.log_state.cljs$lang$applyTo = (function (seq27501){
return mokepon.tests.core.log_state.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27501));
});

mokepon.tests.core.run_tests = (function mokepon$tests$core$run_tests(){
console.clear();

return cljs.test.run_block((function (){var env27508 = cljs.test.empty_env.cljs$core$IFn$_invoke$arity$0();
var summary27509 = cljs.core.volatile_BANG_(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$type,cljs.core.cst$kw$summary,cljs.core.cst$kw$fail,(0),cljs.core.cst$kw$error,(0),cljs.core.cst$kw$pass,(0),cljs.core.cst$kw$test,(0)], null));
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env27508,summary27509){
return (function (){
cljs.test.set_env_BANG_(env27508);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env__23157__auto__,env27508,summary27509){
return (function (){
...
});})(env__23157__auto__,env27508,summary27509))
], null),cljs.test.test_vars_block(cljs.core.PersistentVector.EMPTY),cljs.core.array_seq([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env__23157__auto__,env27508,summary27509){
return (function (){
if((env__23157__auto__ == null)){
...
});})(env27508,summary27509))
,((function (env27508,summary27509){
return (function (){
...
], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env27508,summary27509){
return (function (){
return cljs.core._vreset_BANG_(summary27509,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.merge_with,cljs.core._PLUS_).call(null,cljs.core._deref(summary27509),cljs.core.cst$kw$report_DASH_counters.cljs$core$IFn$_invoke$arity$1(cljs.test.get_and_clear_env_BANG_())));
});})(env27508,summary27509))
], null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env27508,summary27509){
return (function (){
cljs.test.set_env_BANG_(env27508);

cljs.test.do_report((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(summary27509) : cljs.core.deref.call(null,summary27509)));

var G__27510_27511 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(summary27509) : cljs.core.deref.call(null,summary27509)),cljs.core.cst$kw$type,cljs.core.cst$kw$end_DASH_run_DASH_tests);
(cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__27510_27511) : cljs.test.report.call(null,G__27510_27511));
