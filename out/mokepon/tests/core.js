...
var G__27490 = mokepon.container.app_state();
return (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(G__27490) : cljs.core.deref.call(null,G__27490));
});
...
var G__27493_27495 = mokepon.container.app_state();
var G__27494_27496 = mokepon.rpg.new_game();
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__27493_27495,G__27494_27496) : cljs.core.reset_BANG_.call(null,G__27493_27495,G__27494_27496));
...
}catch (e27498){var t__23091__auto__ = e27498;
...
var len__19539__auto___27500 = arguments.length;
var i__19540__auto___27501 = (0);
while(true){
if((i__19540__auto___27501 < len__19539__auto___27500)){
args__19546__auto__.push((arguments[i__19540__auto___27501]));

var G__27502 = (i__19540__auto___27501 + (1));
i__19540__auto___27501 = G__27502;
continue;
} else {
}
break;
...
mokepon.tests.core.get_state.cljs$lang$applyTo = (function (seq27499){
return mokepon.tests.core.get_state.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27499));
});

mokepon.tests.core.log_state = (function mokepon$tests$core$log_state(var_args){
var args__19546__auto__ = [];
var len__19539__auto___27504 = arguments.length;
var i__19540__auto___27505 = (0);
while(true){
if((i__19540__auto___27505 < len__19539__auto___27504)){
args__19546__auto__.push((arguments[i__19540__auto___27505]));

var G__27506 = (i__19540__auto___27505 + (1));
i__19540__auto___27505 = G__27506;
continue;
} else {
}
break;
...
mokepon.tests.core.log_state.cljs$lang$applyTo = (function (seq27503){
return mokepon.tests.core.log_state.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27503));
});

mokepon.tests.core.run_tests = (function mokepon$tests$core$run_tests(){
console.clear();

return cljs.test.run_block((function (){var env27510 = cljs.test.empty_env.cljs$core$IFn$_invoke$arity$0();
var summary27511 = cljs.core.volatile_BANG_(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$type,cljs.core.cst$kw$summary,cljs.core.cst$kw$fail,(0),cljs.core.cst$kw$error,(0),cljs.core.cst$kw$pass,(0),cljs.core.cst$kw$test,(0)], null));
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env27510,summary27511){
return (function (){
cljs.test.set_env_BANG_(env27510);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env__23157__auto__,env27510,summary27511){
return (function (){
...
});})(env__23157__auto__,env27510,summary27511))
], null),cljs.test.test_vars_block(cljs.core.PersistentVector.EMPTY),cljs.core.array_seq([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env__23157__auto__,env27510,summary27511){
return (function (){
if((env__23157__auto__ == null)){
...
});})(env27510,summary27511))
,((function (env27510,summary27511){
return (function (){
...
], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env27510,summary27511){
return (function (){
return cljs.core._vreset_BANG_(summary27511,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.merge_with,cljs.core._PLUS_).call(null,cljs.core._deref(summary27511),cljs.core.cst$kw$report_DASH_counters.cljs$core$IFn$_invoke$arity$1(cljs.test.get_and_clear_env_BANG_())));
});})(env27510,summary27511))
], null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env27510,summary27511){
return (function (){
cljs.test.set_env_BANG_(env27510);

cljs.test.do_report((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(summary27511) : cljs.core.deref.call(null,summary27511)));

var G__27512_27513 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(summary27511) : cljs.core.deref.call(null,summary27511)),cljs.core.cst$kw$type,cljs.core.cst$kw$end_DASH_run_DASH_tests);
(cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__27512_27513) : cljs.test.report.call(null,G__27512_27513));
