...
return mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([mokepon.elements.conditional_a(chosen_can_attack_QMARK_,"Attack!",attack_handler),(cljs.core.truth_(cljs.core.cst$kw$candy.cljs$core$IFn$_invoke$arity$1(items))?mokepon.elements.conditional_a((cljs.core.not(battle_over_QMARK_)) && ((cljs.core.cst$kw$candy.cljs$core$IFn$_invoke$arity$1(items) > (0))),"Candy!",candy_handler):null),(cljs.core.truth_(cljs.core.cst$kw$mokebox.cljs$core$IFn$_invoke$arity$1(items))?mokepon.elements.conditional_a((cljs.core.not(battle_over_QMARK_)) && ((cljs.core.cst$kw$mokebox.cljs$core$IFn$_invoke$arity$1(items) > (0))),"Throw Mok\u00E9box!",throw_mokebox_handler):null),(((cljs.core.not(battle_over_QMARK_)) && ((cljs.core.count(choosable_monsters) > (1))))?(function (){var iter__19244__auto__ = (function mokepon$views$battle$battle_actions_view_$_iter__37830(s__37831){
return (new cljs.core.LazySeq(null,(function (){
var s__37831__$1 = s__37831;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__37831__$1);
if(temp__4657__auto__){
var s__37831__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37831__$2)){
var c__19242__auto__ = cljs.core.chunk_first(s__37831__$2);
var size__19243__auto__ = cljs.core.count(c__19242__auto__);
var b__37833 = cljs.core.chunk_buffer(size__19243__auto__);
if((function (){var i__37832 = (0);
while(true){
if((i__37832 < size__19243__auto__)){
var m = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__19242__auto__,i__37832);
cljs.core.chunk_append(b__37833,mokepon.elements.a([cljs.core.str("Choose "),cljs.core.str(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1((m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(team) : m.call(null,team)))),cljs.core.str("!")].join(''),((function (i__37832,m,c__19242__auto__,size__19243__auto__,b__37833,s__37831__$2,temp__4657__auto__){
return (function (){
...
});})(i__37832,m,c__19242__auto__,size__19243__auto__,b__37833,s__37831__$2,temp__4657__auto__))
));

var G__37836 = (i__37832 + (1));
i__37832 = G__37836;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37833),mokepon$views$battle$battle_actions_view_$_iter__37830(cljs.core.chunk_rest(s__37831__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37833),null);
}
} else {
var m = cljs.core.first(s__37831__$2);
return cljs.core.cons(mokepon.elements.a([cljs.core.str("Choose "),cljs.core.str(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1((m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(team) : m.call(null,team)))),cljs.core.str("!")].join(''),((function (m,s__37831__$2,temp__4657__auto__){
return (function (){
return (choose_monster_handler.cljs$core$IFn$_invoke$arity$1 ? choose_monster_handler.cljs$core$IFn$_invoke$arity$1(m) : choose_monster_handler.call(null,m));
});})(m,s__37831__$2,temp__4657__auto__))
),mokepon$views$battle$battle_actions_view_$_iter__37830(cljs.core.rest(s__37831__$2)));
}
} else {
return null;
}
