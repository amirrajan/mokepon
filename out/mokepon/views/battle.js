...
return mokepon.elements.section.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([mokepon.elements.conditional_a(chosen_can_attack_QMARK_,"Attack",attack_handler),(cljs.core.truth_(cljs.core.cst$kw$candy.cljs$core$IFn$_invoke$arity$1(items))?mokepon.elements.conditional_a((cljs.core.not(battle_over_QMARK_)) && ((cljs.core.cst$kw$candy.cljs$core$IFn$_invoke$arity$1(items) > (0))),"Candy",candy_handler):null),(cljs.core.truth_(cljs.core.cst$kw$mokebox.cljs$core$IFn$_invoke$arity$1(items))?mokepon.elements.conditional_a((cljs.core.not(battle_over_QMARK_)) && ((cljs.core.cst$kw$mokebox.cljs$core$IFn$_invoke$arity$1(items) > (0))),"Throw Mok\u00E9box",throw_mokebox_handler):null),(((cljs.core.not(battle_over_QMARK_)) && ((cljs.core.count(choosable_monsters) > (1))))?(function (){var iter__28792__auto__ = (function mokepon$views$battle$battle_actions_view_$_iter__69785(s__69786){
return (new cljs.core.LazySeq(null,(function (){
var s__69786__$1 = s__69786;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__69786__$1);
if(temp__4657__auto__){
var s__69786__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__69786__$2)){
var c__28790__auto__ = cljs.core.chunk_first(s__69786__$2);
var size__28791__auto__ = cljs.core.count(c__28790__auto__);
var b__69788 = cljs.core.chunk_buffer(size__28791__auto__);
if((function (){var i__69787 = (0);
while(true){
if((i__69787 < size__28791__auto__)){
var m = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__28790__auto__,i__69787);
cljs.core.chunk_append(b__69788,mokepon.elements.a([cljs.core.str("Choose "),cljs.core.str(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1((m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(team) : m.call(null,team)))),cljs.core.str("!")].join(''),((function (i__69787,m,c__28790__auto__,size__28791__auto__,b__69788,s__69786__$2,temp__4657__auto__){
return (function (){
...
});})(i__69787,m,c__28790__auto__,size__28791__auto__,b__69788,s__69786__$2,temp__4657__auto__))
));

var G__69791 = (i__69787 + (1));
i__69787 = G__69791;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__69788),mokepon$views$battle$battle_actions_view_$_iter__69785(cljs.core.chunk_rest(s__69786__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__69788),null);
}
} else {
var m = cljs.core.first(s__69786__$2);
return cljs.core.cons(mokepon.elements.a([cljs.core.str("Choose "),cljs.core.str(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1((m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(team) : m.call(null,team)))),cljs.core.str("!")].join(''),((function (m,s__69786__$2,temp__4657__auto__){
return (function (){
return (choose_monster_handler.cljs$core$IFn$_invoke$arity$1 ? choose_monster_handler.cljs$core$IFn$_invoke$arity$1(m) : choose_monster_handler.call(null,m));
});})(m,s__69786__$2,temp__4657__auto__))
),mokepon$views$battle$battle_actions_view_$_iter__69785(cljs.core.rest(s__69786__$2)));
}
} else {
return null;
}
