...
var map__37766 = monster;
var map__37766__$1 = ((((!((map__37766 == null)))?((((map__37766.cljs$lang$protocol_mask$partition0$ & (64))) || (map__37766.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37766):map__37766);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37766__$1,cljs.core.cst$kw$name);
var mokedex_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37766__$1,cljs.core.cst$kw$mokedex_DASH_text);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37766__$1,cljs.core.cst$kw$type);
var captured = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37766__$1,cljs.core.cst$kw$captured);
var encountered = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37766__$1,cljs.core.cst$kw$encountered);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37777),mokepon$views$mokedex$view_$_iter__37774(cljs.core.chunk_rest(s__37775__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37777),null);
}
} else {
var monster = cljs.core.first(s__37775__$2);
return cljs.core.cons(mokepon.views.mokedex.mokedex_item(monster),mokepon$views$mokedex$view_$_iter__37774(cljs.core.rest(s__37775__$2)));
}
} else {
return null;
}
