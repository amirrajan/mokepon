...
var name = cljs.core.get.call(null,map__25792__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var mokedex_text = cljs.core.get.call(null,map__25792__$1,new cljs.core.Keyword(null,"mokedex-text","mokedex-text",-1514539954));
var type = cljs.core.get.call(null,map__25792__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var captured = cljs.core.get.call(null,map__25792__$1,new cljs.core.Keyword(null,"captured","captured",704575240));
var encountered = cljs.core.get.call(null,map__25792__$1,new cljs.core.Keyword(null,"encountered","encountered",1052334671));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),mokepon.elements.section.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Mok\u00E9dex"], null)),mokepon.elements.section.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ol.mokedex","ol.mokedex",-187214330),(function (){var iter__19244__auto__ = (function mokepon$views$mokedex$view_$_iter__25798(s__25799){
return (new cljs.core.LazySeq(null,(function (){
var s__25799__$1 = s__25799;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__25799__$1);
if(temp__4657__auto__){
var s__25799__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__25799__$2)){
var c__19242__auto__ = cljs.core.chunk_first.call(null,s__25799__$2);
var size__19243__auto__ = cljs.core.count.call(null,c__19242__auto__);
var b__25801 = cljs.core.chunk_buffer.call(null,size__19243__auto__);
if((function (){var i__25800 = (0);
while(true){
if((i__25800 < size__19243__auto__)){
var monster = cljs.core._nth.call(null,c__19242__auto__,i__25800);
cljs.core.chunk_append.call(null,b__25801,mokepon.views.mokedex.mokedex_item.call(null,monster));

var G__25802 = (i__25800 + (1));
i__25800 = G__25802;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25801),mokepon$views$mokedex$view_$_iter__25798.call(null,cljs.core.chunk_rest.call(null,s__25799__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25801),null);
}
} else {
var monster = cljs.core.first.call(null,s__25799__$2);
return cljs.core.cons.call(null,mokepon.views.mokedex.mokedex_item.call(null,monster),mokepon$views$mokedex$view_$_iter__25798.call(null,cljs.core.rest.call(null,s__25799__$2)));
}
} else {
return null;
}
